            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-info"></div><a class="d-block" href="detail.php?id=<?php  $sql3 = "SELECT * FROM products where id = $id ";
                                        $result3 = $conn->query($sql3);
                                       $row3 = $result3->fetch_assoc();
                                       echo $row3['id']; 
                                            ?>"><img class="img-fluid w-100" src="admin/imge/<?php $sql2 = "SELECT * FROM products where id = $id ";
                                        $result2 = $conn->query($sql2);
                                        $row2 = $result2->fetch_assoc();
                                          $image_name = $row2['cover'];
                  ...
                  <div class="product-overlay">
                    ...
                    <input name="qunq" type="hidden" value="<?php echo $row['id'] ?>">
                      <li class="list-inline-item m-0 p-0 solo"><a class="btn btn-sm btn-outline-dark active" href="#"><i class="far fa-heart"></i></a></li>
                ...
                <h6> <a class="reset-anchor" href="detail.php?id=<?php echo $row['id'];?>"><?php  $sql3 = "SELECT * FROM products where id = $id ";
                                        $result3 = $conn->query($sql3);
                                       $row3 = $result3->fetch_assoc();
                                       echo $row3['name']; 
                                            ?></a></h6>
                <p class="small text-muted">$<?php  $sql4 = "SELECT * FROM products where id = $id ";
